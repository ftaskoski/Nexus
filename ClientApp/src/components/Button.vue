...
<template>
  <button
    ...
    class="w-full flex items-center justify-center border border-transparent text-sm font-medium rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors duration-200" :class="[
      buttonTypeClasses,
      buttonSizeClasses,
